...
namespace BasicCqrs.WebApp.Controllers
{
    ...
    public class CliController : Controller
    {
        ...
        public async Task<IActionResult> RunAsync([FromBody] string commandText)
        {
            ...
            // 1. Add an XML documentation file to your domain libraries (see README.md in the Brickweave repository for instructions)
            // 2. Recommended: Disable compiler warnings for missing-documentation (codes 1701, 1702, and 1591) to prevent 
            ...
            // in this demo) are wire it up in Startup.cs.
